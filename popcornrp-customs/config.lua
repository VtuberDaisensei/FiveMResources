...
Config.Mods = {
    ...
    { id = 7,  label = 'フード',                 category = 'parts' },
    { id = 8,  label = '左フェンダー',          category = 'parts' },
    { id = 9,  label = '右フェンダー',         category = 'parts' },
    { id = 10, label = 'ルーフ',                 category = 'parts' },
    { id = 11, label = 'エンジン',       category = 'performance' },
    { id = 12, label = 'ブレーキ',        category = 'performance' },
    { id = 13, label = 'トランスミッション', category = 'performance' },
    { id = 14, label = 'ホーン',                category = 'parts' },
    { id = 15, label = 'サスペンション',   category = 'performance' },
    { id = 16, label = 'アーマー',        category = 'performance', enabled = false },
    ...
    { id = 25, label = 'ナンバープレート',         category = 'parts' },
    ...
    { id = 33, label = 'ステアリング',       category = 'parts' },
    { id = 34, label = 'シフトレバー',       category = 'parts' },
