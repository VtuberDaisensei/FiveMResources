Config = {
    ...
    NPCLocations = {
        TakeLocations = {
            [1] = vector4(257.61, -380.57, 44.71, 340.5), -- 7238前
            [2] = vector4(-48.58, -790.12, 44.22, 340.5), -- 8060前
        ...
        DeliverLocations = {
            ...
            [9] = vector4(1920.93, 3703.85, 32.63, 120.5),  -- 3006 砂漠
            [10] = vector4(1662.55, 4876.71, 42.05, 185.5), -- 2007
            [11] = vector4(-9.51, 6529.67, 31.37, 136.5),   -- 1059
            [12] = vector4(-3232.7, 1013.16, 12.09, 177.5), -- 5037
